...
<img  alt="workflow admin panel image" width="98%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media6/image5.png)">  
...
<img  alt="process register image" width="95%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media6/image6.png)">  
...
<img  alt="process register image" width="70%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media6/image7.png)">  
...
<img  alt="process register image" width="95%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media6/image8.png)">  
...
<img  alt="other parameters image" width="90%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media6/image9.png)"> 


To configure a non-working day, click the **Add Day** button will open a dialog box for setting up the day as shown below:

<img  alt="non working day image" width="70%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media6/image10.png)">  


To configure a holiday, click the **Add Holiday** button will open a dialog box for setting up the day as shown below:

<img  alt="holiday image" width="70%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media6/image11.png)">  