...
<img  alt="workflow dashboard image" width="95%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media6/image1.png)">  
...
<img  alt="Systech configs image" width="90%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media6/image4.png)">  