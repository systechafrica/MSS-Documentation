...
<img  alt="Reserve Fund" width="100%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media3/reservefund.png)"> 
...
<img  alt="Transactions Register" width="95%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media3/transreg.png)"> 
