...
<img  alt="Members Document Checklist" width="97%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media3/memberdocchecklist.png)"> 
...
<img  alt="add memebr document" width="70%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media3/newdocchecklist.png)"> 
...
<img  alt="Process Checklist Application" width="60%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media3/confirmdocdistribution.png)"> 
...
<img  alt="member documents status" width="60%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media3/membersstatus.png)"> 


Click the **What is this** button to open a new window displaying detailed information as shown below:

<img  alt="tracking member document submission status" width="70%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media3/whatisthis.png)"> 
...
<img  alt="Receive Document" width="95%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media3/docchecklistapp.png)"> 