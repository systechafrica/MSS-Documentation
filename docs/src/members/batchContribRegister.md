...
<img  alt="Batch Contributions Register" width="95%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media3/contri10.png)"> 
...
<img  alt="Batch Contribution Distribution to Members" width="95%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media3/contri11.png)"> 
