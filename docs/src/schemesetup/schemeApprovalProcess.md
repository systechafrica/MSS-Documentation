...
<img  alt="scheme approval links" width="100%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/schemeM51.png)">  
...
<img  alt="Scheme Documents Checklist" width="90%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/schemeM8.png)"> 
...
<img  alt="Scheme Approval" width="90%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/schemeM2.png)">  
...
<img  alt="Checklist Validation" width="90%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/schemeM27.png)">  
...
<img  alt="Receive Documents" width="70%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/schemeM73.png)">  
