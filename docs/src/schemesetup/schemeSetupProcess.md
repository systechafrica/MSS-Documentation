...
<img  alt="scheme creation links" width="100%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/schemeM80.png)">  
...
<img  alt="basic scheme deatils form" width="80%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/schemeM74.png)"> 
...
<img  alt="Scheme configurations" width="100%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/scheme82.jpg">  
...
<img  alt="Scheme Setup Configurations" width="80%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/scheme83.jpg">  
...
<img  alt="Member Configurations" width="80%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/scheme84.jpg">  
...
<img  alt="Contributions and balances Configurations" width="80%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/scheme85.jpg">
...
<img  alt="claims and Pensioners Configurations" width="80%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/scheme86.jpg">  
...
<img  alt="Scheme Dates and Insurance covers Configurations" width="80%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/scheme87.jpg">  
...
<img  alt="Benefits Configurations" width="95%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/scheme88.jpg">
...
<img  alt="additional scheme info setup" width="80%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/schemeM19.png)">  
...
<img  alt="additional scheme info" width="80%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/schemeM75.png)">  
...
<img  alt="Module Allowance Configuration" width="70%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/schemeM63.png)"> 
...
<img  alt="Scheme Dates and Insurance Cover" width="80%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/schemeM20.png)">  
...
<img  alt="regions" width="90%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/schemeM18.png)">  
...
<img  alt="regions" width="90%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/schemeM54.png)">  
...
<img  alt="Upload Documen" width="80%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/schemeM22.png)">  
...
<img  alt="Upload Documen" width="80%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/schemeM55.png)">  


The window below shows the list of all uploaded documents:

<img  alt="Upload Documents list" width="80%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media2/schemeM61.png)">  
