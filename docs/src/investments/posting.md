...
<img  alt="postings menu" width="95%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media7/postings menu.png)">  
...
<img  alt="property posting window" width="90%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media7/propertyPosting.png)">  
