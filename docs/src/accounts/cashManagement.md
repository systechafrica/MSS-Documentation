...
<img  alt="Cash Management" width="100%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media4/image1.png)"> 
...
<img  alt="Cashbooks Register" width="95%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media4/image2.png)"> 
...
<img  alt="New Cashbook " width="95%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media4/image3.png)"> 
...
<img  alt="cashbook register with new direct receipt link" width="95%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media4/image3a.png)"> 
...
<img  alt="payee/payer details dialog box" width="86%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media4/image3b.png)"> 
...
<img  alt="direct receipt details dialog box" width="86%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media4/image3c.png)"> 
...
<img  alt="add credit line dialog box" width="86%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media4/image3d.png)"> 
...
<img  alt="receipt line dialog box" width="95%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media4/image3e.png)"> 
...
<img  alt="Currencies" width="90%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media4/image4.png)"> 


Click the **Add Currency** button to open a dialog box through which a new Currency is configured as shown below:

<img  alt="Add Currency" width="70%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media4/image5.png)"> 
...
<img  alt="Exchange Rates" width="90%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media4/image6.png)"> 
...
<img  alt="VAT Rates" width="90%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media4/image7.png)"> 
...
<img  alt="New Categorie" width="90%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media4/image8.png)"> 
...
<img  alt="Withholding V.A.T Rates" width="90%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media4/image9.png)"> 
...
<img  alt="Withholding Tax Categories" width="90%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media4/image10.png)"> 
...
<img  alt="Withholding Tax Rates" width="90%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media4/image11.png)"> 
...
<img  alt="Corporate Tax" width="90%" height="auto"  class="center"  src="![Image from alias](~@alias/img/media4/image12.png)"> 
